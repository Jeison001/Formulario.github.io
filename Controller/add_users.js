...
async function Agregar(){
    ...
    const cuenta = document.getElementById('edtfecha').value;

    const verificar = addregister(nombres, apellidos, fecha, cedula, estado, rh, genero, telefono, direccion, email,cuenta)
